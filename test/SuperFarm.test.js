...
const SuperFarm = artifacts.require('SuperFarm');
const MockBEP20 = artifacts.require('libs/MockBEP20');

contract('SuperFarm', ([alice, bob, carol, dev, minter]) => {
  beforeEach(async () => {
    ...
    this.chef = await SuperFarm.new(this.syrup.address, this.reward.address, '40', '300', '400', {
      from: minter,
    });
  });
  ...
  it('sous chef now', async () => {
    ...
    await expectRevert(this.chef.withdraw('50', { from: carol }), 'amount exceeded');
